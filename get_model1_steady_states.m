function [H_low_ss,H_high_ss] = get_model1_steady_states(r,S,KH,lambda_d)
...
[~, H_low] = ode45(@(t,h)rescaled_mdl1_odes_1(t,h,r,S,KH,lambda_d),0:10000, 0);
H_low_ss = H_low(end,1);

[~, H_high] = ode45(@(t,h)rescaled_mdl1_odes_1(t,h,r,S,KH,lambda_d),0:10000, H0);
