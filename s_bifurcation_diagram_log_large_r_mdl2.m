function zero_vec = s_bifurcation_diagram_log_large_r_mdl2(s_vec,r, axis_font, label_font, colormap,lw)
%r_bifurcation_diagram draws H vs r_vec bifurcation diagram for type I TA
%systems model 2
%   This function draws a bifurcation diagram for the values of 
%   of parameter s given in s_vec and a set value of parameter r, 
%   for large values of r and with H on log scale:
