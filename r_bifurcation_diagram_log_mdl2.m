function zero_vec = r_bifurcation_diagram_log_mdl2(r_vec,s,axis_font, label_font, colormap,lw)
...
plot(r_low_vec, log(low_zero_vec), Color=colormap(1,:), LineWidth=lw, LineStyle= "-")
hold on
plot(r_unstable_vec,log(unstable_zero_vec), Color=colormap(2,:), LineWidth=lw, LineStyle="--")
plot(r_high_vec, log(high_zero_vec), Color=colormap(3,:), LineWidth=lw, LineStyle="-")
ax = gca;
