%% Parameter tuning for stochastic simulations model 2
...
res = mdl2_single_stochastic_sim(S,r,K_H,tmax);

figure
plot(res(1,:), res(2,:), 'Color',colormap(2,:))
hold on 

[T,Z_low] = ode45(@(t,z)rescaled_mdl2_odes_1(t,z,r,S,K_H, lambda_d),0:0.1:tmax,0);

plot(T,Z_low(:,1), 'Color',colormap(1,:))

[T,Z_high] = ode45(@(t,z)rescaled_mdl2_odes_1(t,z,r,S,K_H, lambda_d),0:0.1:tmax,300);
...
[H_low_ss, H_high_ss] = get_model2_steady_states(r,S,K_H,lambda_d);
...
%% Save the figure
fig_title = "TypeI_mdl2_stochastic_very_long_r0"+ num2str(r*100) + "_S0" + num2str(S*100) + "_KH" + num2str(K_H);
