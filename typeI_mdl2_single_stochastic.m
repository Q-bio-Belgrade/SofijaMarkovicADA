% Type I TA model 2: drawing single srochastic sim + low and high
% determnnistic state
    ...
    for S=S_vec
        for r = r_vec
            for K_H = KH_vec
                ...
                plot(t_vec, H_vec,"LineWidth",1.5, "Color",  grey)
                
                hold on
                
                [T,Z] = ode45(@(t,z)rescaled_mdl2_odes_1(t,z,r,S,K_H, lambda_d),0:0.1:tmax,H0_low);
                
                plot(T,Z(:,1),"LineWidth",2, "Color", blue)
                
                [T,Z] = ode45(@(t,z)rescaled_mdl2_odes_1(t,z,r,S,K_H, lambda_d),0:0.1:tmax,H0_high);
                
                plot(T,Z(:,1),"LineWidth",2,"Color",red)
                ...
                hold off
                fig_title = "TypeI_mdl2_single_stochastic_r0"+ num2str(r*10) + "_S0" + num2str(S*100) + "_KH" + num2str(K_H) + "_" + num2str(i);
