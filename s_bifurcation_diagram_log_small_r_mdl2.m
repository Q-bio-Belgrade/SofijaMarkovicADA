function zero_vec = s_bifurcation_diagram_log_small_r_mdl2(s_vec,r, axis_font, label_font, colormap,lw)
...
%   of parameter s given in s_vec and a set value of parameter r, for small 
%   r values and H on log scale:
